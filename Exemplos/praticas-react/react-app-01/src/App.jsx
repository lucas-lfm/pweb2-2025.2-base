...
export default function App() {
  ...
  const altura = 0; // essa é uma variável comum do JavaScript, o React não controla o valor dela como estado
  const peso = 0; // essa é uma variável comum do JavaScript, o React não controla o valor dela como estado
  ...
  const calcularIMC = (evento) => {
    ...
    setImc(20); // atualiza o valor do estado imc para 20
  }
  ...
  return (
    <>
      ...
      <form onSubmit={calcularIMC}>
        ...
        <input type="number" id="altura" placeholder='Sua altuta em metros' step={0.01} min={0} />

        <label htmlFor="peso">Peso</label>
        <input type="number" id="peso" placeholder='Seu peso em kg' step={0.01} min={0} />
